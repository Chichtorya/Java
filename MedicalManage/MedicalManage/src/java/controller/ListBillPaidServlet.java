 ...
 * @author PC
 */
@WebServlet(name="ListBillPaidServlet", urlPatterns={"/listBillPaid"})
public class ListBillPaidServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
      ...
      ArrayList<Bill> list = dao.getAllBillByStatus(1);
       int page, numberpage = 8;
        ...
        ArrayList<Bill> list1 = dao.getListByPage(list, start, end);
        request.setAttribute("ListBill", list1);
        request.setAttribute("page", page);
        request.setAttribute("numberpage", num);
      request.getRequestDispatcher("ListBillPaid.jsp").forward(request, response);
    } else{
