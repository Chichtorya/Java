...
<html>
    ...
    <body>
        ...
        <form method="post">
            ...
            gender:
             <c:if  test="${pa.gender.equals('Male')}">
            ...
            <c:if  test="${pa.gender.equals('Female')}">
                   <input  type="radio" value ="Female" name="gender" checked> FeMale             
             </c:if>
             <c:if  test="${!pa.gender.equals('Female')}">
                   <input  type="radio" value ="Female" name="gender"> FeMale             
             </c:if> 
            <c:if  test="${pa.gender.equals('Unknow')}">
        ...
        <a href="/patient" type="submit" class="btn btn-success">Back</a>
    </body>
</html>
