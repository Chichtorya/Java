...
public class ImmunoassTest {
   ...
   private float TotalPSA;
    ...
    public ImmunoassTest(int Id, float Digoxin, float Estradiol, float Ferritin, float FAcid, float Progesterone, float Prolactin, float TroponinT, float Testosterone, float PSA) {
