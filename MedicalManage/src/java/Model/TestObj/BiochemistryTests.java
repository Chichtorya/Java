...
public class BiochemistryTests {
    ...
    public BiochemistryTests(int Id, float Fasting, float PP, float Urea, float S_Cr, float Sodium, float Potassium, float Choloride, float TCalcium, float UricAcid, float TBilirubin, float AP, float TProtein, float Albumin, float TCholesterol, float Triglyceride, float ADA) {
