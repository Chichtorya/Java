...
<html>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="home">
                                <hr>
                                <div class="form" action="##" method="post" enctype="multipart/form-data" id="registrationForm">
                                    <div class="form-group">

                                        <div class="col-xs-6">
                                            <label for="first_name"><h4>Name</h4></label>
                                            <input type="text"  pattern="[a-zA-Z0-9]{5-20}" class="form-control" name="name" required value="${requestScope.u.name}" id="first_name" placeholder="first name" title="enter your first name if any.">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <input type="number" required   pattern="(84|0[3|5|7|8|9])+([0-9]{8})\b" value="${requestScope.u.phone}" class="form-control" name="phone" id="last_name" placeholder="last name" title="enter your last name if any.">
    <!--                                         <p style="color: red">${requestScope.msPhone}</p>-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <input type="date" required value="${requestScope.u.date_Of_Birth}" min="1900-01-01" max="2023-02-07" class="form-control" name="date" id="phone" placeholder="enter phone" title="enter your phone number if any.">
    ...
    <!--                                      <p style="color: red">${requestScope.msHealth}</p>-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" value="${requestScope.u.address}" name="address" id="password" placeholder="password" title="enter your password.">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <input type="gmail"  pattern="(\W|^)[\w.+\-]*@gmail\.com(\W|$)" class="form-control" value="${requestScope.u.gmail}" name="gmail" id="password2" placeholder="password2" title="enter your password2.">
    <!--                                     <p style="color: red">${requestScope.msGmail}</p>-->
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                            <br>
                                            <c:if test="${sessionScope.account.id == requestScope.u.id || sessionScope.account.role == 1}">
