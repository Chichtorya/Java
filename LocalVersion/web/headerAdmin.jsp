    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="/listDoctor">
              <i class="bi bi-circle"></i><span>List account doctors</span>
            </a>
           </li>    
          <li>
            <a href="/listReception">
              <i class="bi bi-circle"></i><span>List account reception</span>
            </a>
           </li>
          <li>
            <a href="/listPatient">
              <i class="bi bi-circle"></i><span>List account patient</span>
            </a>
           </li>
            <li>
            <a href="/listBlock">
              <i class="bi bi-circle"></i><span>List account block</span>
            </a>
           </li>
        </ul>
      </li>
