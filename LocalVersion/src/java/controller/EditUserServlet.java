        ...
        if (action.equals("editUser")) {
            ...
            if (user != null) {
                ...
                if (name.length() > 35 || address.length() > 50) {
                    ...
                    String uploadPath = "C:\\Users\\dell\\Documents\\NetBeansProjects\\G6\\g6\\MedicalManage\\web\\images\\" + photo;
                    try {
                        ...
                        User u = new User(name, photo, phone, date, gender1, citizen, health, address, gmail);
                        dao.editUserByCustomer(u, user.getId());
                        session.setAttribute("account", dao.getUserById(user.getId()));
                        String ms = "Update success !!!";
