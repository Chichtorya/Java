...
```
cd existing_repo
git remote add origin https://gitlab.com/buidinhchien/se1640/g6.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/buidinhchien/se1640/g6/-/settings/integrations)
